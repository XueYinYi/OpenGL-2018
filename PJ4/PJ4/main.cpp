...
Display( )
{
    ...
    SetSpotLight(GL_LIGHT2, 0., 3., 8., 0., -3., 0., 0., 1., 0.2);
    ...
    if (TexOn == OFF) {
        ...
        glPushMatrix();
        glTranslatef(-8., 2, 8.);
        SetMaterial(Grey[0], Grey[1], Grey[2], 64);
        MjbSphere(1, 100, 100);
        glPopMatrix();
        ...
        if (ImgOn == ONE) {
            ...
            Textures =
            BmpToTexture("/Users/Yi/Desktop/GPU Open GL/pj3/pj3/universe.bmp", &ear_width, &ear_height);
            ...
            Textures =
            BmpToTexture("/Users/Yi/Desktop/GPU Open GL/pj3/pj3/worldtex.bmp", &ear_width, &ear_height);
            glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
            glGenTextures( 1, &tex0 ); // assign binding “handles”
            glBindTexture(GL_TEXTURE_2D, tex0);
...
InitLists( )
{
    ...
    SetMaterial(0, 0, 1, 64);
    glPushMatrix();
    //load ojb files
    glTranslated(0, -3, 15);
    glScalef(0.1, 0.1, 0.1);
    glRotated(270,0,0,0);
    LoadObjFile( "/Users/Yi/Desktop/GPU Open GL/PJ4/PJ4/Mustang_GT/3D Files/OBJ/mustang_GT.obj"
                );
    ...
    glShadeModel( GL_SMOOTH );
    glPushMatrix();
    SetMaterial(Red[0], Red[1], Red[2], 64);
    ...
    SetMaterial( White[0], White[1], White[2], 0.00001);
    glutSolidCube(2);
    glPopMatrix();
    glDisable( GL_LIGHTING );
    glEndList();
