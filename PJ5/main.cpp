...
//  PJ4
//
//  Created by Yi on 10/22/18.
//  Copyright © 2018 Yin Xue. All rights reserved.
//
//Name: Yin Xue.
//ONID: 933014789
//Email: xueyi@oregonstate.edu
...
float Size;
bool  Freeze;
float VertexShaderTime, FragShaderTime;
...
Display( )
{
    ...
    gluLookAt( 9.8, 3., -20.,     0., 0., 0.,     0., 1., 0. );
    ...
    if (MyButton != 3) {
        ...
        //For stationary both shader
        if (MyButton == 1 || MyButton == 4) {
            VertexShaderTime = Time;
        }
        if (MyButton == 1 || MyButton == 2) {
            FragShaderTime = Time;
        }
        // draw the current object:
        Ds = 1.*cos(M_PI*FragShaderTime);
        Dt = 0.8 * sin(M_PI*FragShaderTime);
        Ka = 0.9;
        Kd = 0.8;
        Ks = .5;
        ColorR = 0.6*sin(M_PI*VertexShaderTime);
        ColorG = 0.5;
        ColorB = 0.2*sin(M_PI*VertexShaderTime);
        Shininess = 50.;
        S0 = 0.2;
        T0 = 0.2;
        S1 = 0.6;
        ...
        Pattern->SetUniformVariable( "uS1", S1 );
        Pattern->SetUniformVariable( "uT1", T1 );
        Pattern->SetUniformVariable( "uDt",  Dt );
        Pattern->SetUniformVariable("uWhichkeyBoardButton", MyButton);
        
        Pattern->SetUniformVariable( "uTime",  VertexShaderTime );
...
//        glTranslatef(-8., 4, 8.);
//        //glShadeModel( GL_FLAT );
//        SetMaterial(Grey[0], Grey[1], Grey[2], 66);
//        MjbSphere(1, 100, 100);
//        glPopMatrix();
//
//
...
//
//            Textures =
//            BmpToTexture("/Users/yin/Desktop/GPU Open GL/pj4/PJ4/PJ4/universe.bmp", &ear_width, &ear_height);
...
InitGraphics( )
{
    ...
    bool valid = Pattern->Create( "/Users/yin/Desktop/GPU Open GL/pj5/pj5/pj5/pattern.vert", "/Users/yin/Desktop/GPU Open GL/pj5/pj5/pj5/pattern.frag" );
    if( ! valid )
    {
...
//    glRotated(270,0,0,0);
//    LoadObjFile( "/Users/yin/Desktop/GPU Open GL/pj4/PJ4/PJ4/Mustang_GT/3D Files/OBJ/mustang_GT.obj"
//                );
//
//
//    glPopMatrix();
